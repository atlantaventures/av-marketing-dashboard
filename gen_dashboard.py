...
<header class="header">
  ...
  <div style="display:flex;align-items:center;gap:10px">
    <button class="period-btn" id="period-btn" onclick="toggleFilter()">
      ...
      <span id="period-label-primary" style="font-weight:700;">6/1/2026 - 6/30/2026</span>
      <span id="period-label-compare" style="font-weight:400;opacity:0.6;margin-left:6px;">vs 5/1/2026 - 5/31/2026</span>
    ...
    <div class="fp-controls">
      <div>
        ...
        <div class="fp-date-range" style="margin-top:8px">
          <input class="fp-date-input" id="fp-from" type="text" value="6/1/2026" placeholder="M/D/YYYY" oninput="onCustomDateInput()">
...
// ── DATA ──────────────────────────────────────
const DATA = {
  meta:{client:"Atlanta Ventures",period:"Jun 2026",period_key:"2026-06",pulled:"July 15, 2026"},
  narrative:{
    "2026-06":{
    overview:{
...
// ── FILTER PRESETS ───────────────────────────
const presetDates = {
  current_month: {from:'6/1/2026',  to:'6/30/2026', cFrom:'5/1/2026',  cTo:'5/31/2026', note:'Comparing 30 days to 31 days.', label:'Current Month'},
  last_month:    {from:'6/1/2026',  to:'6/30/2026', cFrom:'5/1/2026',  cTo:'5/31/2026', note:'Comparing 30 days to 31 days.', label:'Last Month'},
  last_3_months: {from:'4/1/2026',  to:'6/30/2026', cFrom:'1/1/2026',  cTo:'3/31/2026', note:'Comparing 91 days to 90 days.', label:'Last 3 Months'},
  last_6_months: {from:'1/1/2026',  to:'6/30/2026', cFrom:'7/1/2025',  cTo:'12/31/2025',note:'Comparing 181 days to 184 days.',label:'Last 6 Months'},
  ytd:           {from:'1/1/2026',  to:'6/30/2026', cFrom:'1/1/2025',  cTo:'6/30/2025', note:'Comparing 181 days to 181 days.',label:'Year to Date'},
...
function renderEvents(){
  ...
  const ohCurrent=oh.june||null;
  const ohHistory=[...(oh.history||[])].reverse().slice(-6);
  // Detect if there was a HEM event this reporting period
  ...
  document.getElementById('events-grid').innerHTML=`
    <div class="event-card">
      ...
      ${`<div class="event-kpis" style="margin-bottom:16px">
        <div><div class="event-kpi-label">RSVPs ${iTag('Eventbrite')}</div><div class="event-kpi-value">${hemCurrent?hemCurrent.rsvps:0}</div></div>
        <div><div class="event-kpi-label">Attended ${iTag('Eventbrite')}</div><div class="event-kpi-value">${hemCurrent?hemCurrent.attended:0}</div></div>
        <div><div class="event-kpi-label">Show Rate ${iTag('Eventbrite')}</div><div class="event-kpi-value">${hemCurrent?hemCurrent.conversion:"--"}</div></div>
      </div>`}
    </div>
    <div class="event-card">
