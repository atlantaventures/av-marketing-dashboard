...
const DATA = {
  ...
  narrative:{
    ...
    newsletters:{
      read:"• Mailchimp has no data this month — the Mailchimp MCP connector appears disconnected in this session, and no manual fallback numbers were available in time for this pull; this is a full gap, not a no-send month\\n• LinkedIn Newsletter sent 2 articles (Aug 5: 3,210 impressions/182 interactions; Aug 12: 1,070 impressions/54 interactions) — combined impressions of 4,280 are up 94.6% vs July's 2,199, and combined engagements of 236 are up sharply from July's 25\\n• LinkedIn Newsletter subscriber count wasn't captured this month (Metricool's evolution metrics don't expose a subscriber count field, and the source used in prior months — manual screenshots — wasn't available in this pull); July's last known figure was 3,523\\n• Article titles for the two August sends aren't available from Metricool's data (it returns performance metrics but not the newsletter's actual headline) — placeholder date-based labels were used instead",
      rec:"• Resolve the Mailchimp connector gap before next month — either reconnect the MCP integration or establish a reliable manual pull process, since a second consecutive missing month would start to look like the multi-month email silence flagged earlier this year\\n• Get the actual LinkedIn Newsletter subscriber count and article titles from LinkedIn's own admin panel (via screenshot, same as prior months) to fill in what Metricool's API doesn't expose\\n• The LinkedIn Newsletter engagement jump (25 → 236) is large enough to sanity-check against LinkedIn's own dashboard before treating it as a real trend"
    },
    content:{
  ...
  months:{
    "2026-08":{
      ...
      newsletters:{
        ...
        linkedin_newsletter:{
          subscribers:{v:null,mom:null,yoy:null},impressions:{v:4280,mom:null,yoy:null},
          engagements:{v:236,mom:null,yoy:null},article_views:{v:null,mom:null,yoy:null},
          engagement_rate:{v:"5.5%",mom:null,yoy:null},no_send:false,
          top_articles:[
          {title:"LinkedIn Newsletter Send (Aug 5, 2026)",open_rate:"",click_rate:"",impressions:3210,reach:null,engagements:182,eng_rate:"5.7%",article_views:null,email_sends:null},
          {title:"LinkedIn Newsletter Send (Aug 12, 2026)",open_rate:"",click_rate:"",impressions:1070,reach:null,engagements:54,eng_rate:"5.0%",article_views:null,email_sends:null}
          ]
        }
      },
      content:{
